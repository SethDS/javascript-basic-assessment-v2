...
function removeThings(arr, item){
...
function clockIn(emp, dept){
	var yoLo = new Object();
	yoLo.name = emp;
	yoLo.department = dept;
	yoLo.timestamp = new Date();
	return yoLo;
}
